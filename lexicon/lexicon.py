LEXICON: dict[str, str] = {
    ...
    'add_date': "Теперь отправь дату рождения в формате ДД.ММ.ГГГГ (например: 15.05.1990):",
    'invalid_date': "Неверный формат даты. Попробуй ещё раз в формате ДД.ММ.ГГГГ:",
    'birthday_added': "Добавлен день рождения: {name} - {date}.",
    # Сообщения для вывода списка дней рождений
    'show_list': "Список дней рождения:",
    'birthday_entry': "{name} - {date} ({age} лет)",  # Обновленный шаблон
